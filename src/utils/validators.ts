...
export const isValidCPF = (cpf: string): boolean => {
	...
	if (!REGEX.CPF.test(cpf)) return false;
 ...
 */
export const isValidNomeCompleto = (nome: string): boolean => {
 ...
 */
export const isValidDataISO = (data: string): boolean => {
	if (!data || typeof data !== 'string') return false;
	if (!REGEX.DATA_ISO.test(data)) return false;
 ...
 */
export const isValidDataBR = (data: string): boolean => {
	if (!data || typeof data !== 'string') return false;
	if (!REGEX.DATA_BR.test(data)) return false;
 ...
 */
export const isValidIdadeMinima = (dataNascimento: string, idadeMinima: number = 18): boolean => {
	if (!isValidDataISO(dataNascimento)) return false;
 ...
 */
export const validateContact = (contact: ContactData): ValidationResult => {
 ...
 */
export const validateInscricao = (inscricao: Partial<InscricaoData>): ValidationResult => {
	const errors: Record<string, string> = {};
 ...
 */
export const validateSeguro = (seguro: Partial<SeguroData>): ValidationResult => {
	const errors: Record<string, string> = {};
 ...
 */
export const validateContactErrors = (contact: ContactData): string[] => {
	const result = validateContact(contact);
	return result.valid ? [] : Object.values(result.errors);
};

export const validateInscricaoErrors = (inscricao: Partial<InscricaoData>): string[] => {
	const result = validateInscricao(inscricao);
	return result.valid ? [] : Object.values(result.errors);
};

export const validateSeguroErrors = (seguro: Partial<SeguroData>): string[] => {
