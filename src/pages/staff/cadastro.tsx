...
export default function StaffCadastroPage() {
  ...
  if (isSubmitted) {
    return (
      <>
        <SEOHead
          title="INTERBØX - Cadastro Staff Confirmado"
          description="Seu cadastro como Staff foi realizado com sucesso na INTERBØX."
          type="website"
        />
            ...
            <div className="max-w-2xl mx-auto text-center">
              <div className="bg-green-900/20 border border-green-500/30 rounded-3xl p-8 mb-8">
                ...
                <p className="text-gray-300 text-lg mb-6">
                  Seu cadastro como Staff foi realizado com sucesso. 
  ...
  return (
    <>
              <SEOHead
          title="Cerrado INTERBØX 25 - Cadastro STAFF"
          description="Cadastre-se como Staff na INTERBØX. Seja parte da equipe que faz a magia acontecer."
          type="website"
        />
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-300">
                Seja parte da equipe que faz a magia acontecer. 
                Organize, coordene e garanta o sucesso da INTERBØX
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-neutral-800 border border-gray-600 rounded-2xl text-white placeholder-gray-400 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 transition-all duration-200"
                    placeholder="Conte um pouco sobre sua experiência em eventos fitness..."
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-neutral-800 border border-gray-600 rounded-2xl text-white placeholder-gray-400 focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 transition-all duration-200"
                    placeholder="Conte sua motivação para participar como Staff..."
                  />
                </div>
